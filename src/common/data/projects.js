...
const projects = [
  {
    ...
    files: [
      { name: "Mintouge Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Mintouge Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Mintouge Logo.Zip", size: "2.02 MB", link: "#" },
